...
public class TestSolr {
	...
	public void test01() throws IOException{
		...
		*//**
		...
		document2.add(new LongField("id", 6666666L, Store.YES));
		document2.add(new TextField("title", "Apple 蹦啥卡拉卡 X20 全面屏双摄拍照手机 4GB+64GB 磨砂黑 移动联通电信全网通4G手机 双卡双待 ", Store.YES));
		document2.add(new TextField("sellPoint", "两年无压力！", Store.YES));
		document2.add(new DoubleField("price", 5988.00, Store.YES));
		document2.add(new TextField("itemDesc", "）前置摄像头：2x1200万像素（2400万感光单元） 核      数：八核", Store.YES));
		//将索引文件写入到文档中
